...
export const BurgerIngredients: FC = () => {
  ...
  // Берём список всех ингредиентов
  ...
  // Разделяем ингредиенты на булки, начинки и соусы для отображения по категориям
  ...
  return (
    // Передаём все данные и функции в UI-компонент
    <BurgerIngredientsUI
